...
import { RuntimeModuleMetadata } from '@sylo/polkadot-types/Metadata/v0/Modules';
import { Methods, ModulesWithMethods } from '@sylo/polkadot-types/primitive/Method';
import MetadataV0 from '@sylo/polkadot-types/Metadata/v0';
